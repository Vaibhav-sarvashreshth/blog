...
[Longest Path In Matrix](#longest-path-in-matrix)
...
[Dice Throw Problem](#dice-throw-problem)
[Box Stacking](#box-stacking)
[Egg Dropping Puzzle](#egg-dropping-puzzle)
[Max length chain](#max-length-chain)
...
[Count subsequences of type a^i, b^j, c^k](#count-subsequences-of-type-a^i-b^j-c^k)
[Get Minimum Squares](#get-minimum-squares)
[Nth Fibonacci Number](#nth-fibonacci-number)
[Longest Palindromic Substring](#longest-palindromic-substring)
[Total Decoding Messages](#total-decoding-messages)
[Unique BST’s](#unique-bst’s)
[Player with max score](#player-with-max-score)
[Form a palindrome](#form-a-palindrome)
[Word Wrap Problem](#word-wrap-problem)
[Count Palindromic Subsequences](#count-palindromic-subsequences)
[Minimum time to finish tasks without skipping two consecutive](#minimum-time-to-finish-tasks-without-skipping-two-consecutive)
